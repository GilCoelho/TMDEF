"""
Django settings for TMDEV project.
...
SECRET_KEY = "django-insecure-z^y_)-g@%c!(%^2ade@xiy2ivo)9$@#z@k@24il@8916%z519="
...
WSGI_APPLICATION = "TMDEV.wsgi.application"
